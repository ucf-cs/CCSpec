	...
	mo_graph(new CycleGraph())
{
	...
	//CLP ADDED
	//program_stack->register_engine(this);
}
...
bool ModelExecution::initialize_curr_action(ModelAction **curr)
{
	...
	Node * const node = node_stack->get_node(head_index);
    ModelAction * const act = node->get_action();
    program_stack.push_back(act);
...
ModelAction * ModelExecution::check_current_action(ModelAction *curr)
{
    ...
    //CLP ADDED
    //if (curr->is_linearization_point() || curr->is_function_call())
        //return curr;
...
{
 /*
    ModelAction const *temp;
    ModelVector<const ModelAction *> myvector;
    myvector.push_back(temp);
 */
    //CLP ADDED
    //program_stack.push_back(curr);
