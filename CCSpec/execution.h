...
public:
	...
	//CLP ADDED
	NodeStack * get_node_stack() const { return node_stack; }

	//ModelVector<ModelAction *> program_stack;
	
	//ModelVector<ModelAction*> get_program_stack() const { return program_stack; }

	//void push_to_stack(ModelAction* act) {program_stack.push_back(act); }
