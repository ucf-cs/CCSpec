...
typedef struct atomic_bool
{
    ...
    atomic_bool() = delete;
     constexpr explicit atomic_bool( bool __v__ ) : __f__( __v__ ) { }
...
typedef struct atomic_address
{
    ...
    void* fetch_sub( ptrdiff_t, memory_order = memory_order_seq_cst ) volatile;
     ...
     constexpr explicit atomic_address( void* __v__ ) : __f__( __v__) { }
...
typedef struct atomic_char
{
    ...
    char fetch_xor( char,
     ...
     atomic_char() = default;
     constexpr atomic_char( char __v__ ) : __f__( __v__) { }
...
typedef struct atomic_schar
{
    ...
    signed char fetch_xor( signed char,
     ...
     constexpr atomic_schar( signed char __v__ ) : __f__( __v__) { }
...
typedef struct atomic_uchar
{
    ...
    atomic_uchar() = default;
     constexpr atomic_uchar( unsigned char __v__ ) : __f__( __v__) { }
...
typedef struct atomic_short
{
    ...
    atomic_short() = default;
     constexpr atomic_short( short __v__ ) : __f__( __v__) { }
...
typedef struct atomic_ushort
{
    ...
    unsigned short fetch_xor( unsigned short,
     ...
     constexpr atomic_ushort( unsigned short __v__ ) : __f__( __v__) { }
...
typedef struct atomic_int
{
    ...
    int fetch_xor( int,
     ...
     atomic_int() = default;
     constexpr atomic_int( int __v__ ) : __f__( __v__) { }
...
typedef struct atomic_uint
{
    ...
    unsigned int fetch_xor( unsigned int,
     ...
     atomic_uint() = default;
    constexpr atomic_uint( unsigned int __v__ ) : __f__( __v__) { }
...
typedef struct atomic_long
{
    ...
    long fetch_xor( long,
     ...
     atomic_long() = default;
    constexpr atomic_long( long __v__ ) : __f__( __v__) { }
...
typedef struct atomic_ulong
{
    ...
    unsigned long fetch_xor( unsigned long,
     ...
     constexpr atomic_ulong( unsigned long __v__ ) : __f__( __v__) { }
...
typedef struct atomic_llong
{
    ...
    long long fetch_xor( long long,
     ...
     constexpr atomic_llong( long long __v__ ) : __f__( __v__) { }
...
typedef struct atomic_ullong
{
    ...
    atomic_ullong() = default;
     constexpr atomic_ullong( unsigned long long __v__ ) : __f__( __v__) { }
...
typedef struct atomic_wchar_t
{
    ...
    wchar_t fetch_xor( wchar_t,
     ...
     constexpr atomic_wchar_t( wchar_t __v__ ) : __f__( __v__) { }
...
struct atomic
{
    ...
    bool compare_exchange_strong( T&, T, memory_order = memory_order_seq_cst ) volatile;
     ...
     atomic() = default;
     constexpr explicit atomic( T __v__ ) : __f__( __v__ ) { }
...
template<typename T> struct atomic< T* > : atomic_address
{
    ...
    T* fetch_sub( ptrdiff_t, memory_order = memory_order_seq_cst ) volatile;
     ...
     atomic() = default;
     constexpr explicit atomic( T* __v__ ) : atomic_address( __v__ ) { }
    atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
     atomic() = default;
     constexpr explicit atomic( bool __v__ )
    : atomic_bool( __v__ ) { }
     atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
    atomic() = default;
     constexpr explicit atomic( void* __v__ )
...
{
  atomic() = default;
     constexpr explicit atomic( char __v__ )
    : atomic_char( __v__ ) { }
     atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
     atomic() = default;
     constexpr explicit atomic( signed char __v__ )
    : atomic_schar( __v__ ) { }
     atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
     atomic() = default;
     constexpr explicit atomic( unsigned char __v__ )
    : atomic_uchar( __v__ ) { }
     atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
    atomic() = default;
     constexpr explicit atomic( short __v__ )
    : atomic_short( __v__ ) { }
     atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
    atomic() = default;
    constexpr explicit atomic( unsigned short __v__ )
    : atomic_ushort( __v__ ) { }
    atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
   atomic() = default;
   constexpr explicit atomic( int __v__ )
  : atomic_int( __v__ ) { }
   atomic( const atomic& ) = delete;
  atomic& operator =( const atomic& ) =delete;
...
{
     atomic() = default;
     constexpr explicit atomic( unsigned int __v__ )
    : atomic_uint( __v__ ) { }
     atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& )=delete;
...
{
     atomic() = default;
     constexpr explicit atomic( long __v__ )
    : atomic_long( __v__ ) { }
    atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
     atomic() = default;
     constexpr explicit atomic( unsigned long __v__ )
    : atomic_ulong( __v__ ) { }
     atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
    atomic() = default;
     constexpr explicit atomic( long long __v__ )
    : atomic_llong( __v__ ) { }
    atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
     atomic() = default;
     constexpr explicit atomic( unsigned long long __v__ )
    : atomic_ullong( __v__ ) { }
     atomic( const atomic& ) = delete;
    atomic& operator =( const atomic& ) =delete;
...
{
     atomic() = default;
    constexpr explicit atomic( wchar_t __v__ )
